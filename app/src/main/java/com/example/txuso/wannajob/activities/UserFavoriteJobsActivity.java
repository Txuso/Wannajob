...
public class UserFavoriteJobsActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        Intent chatIntent = new Intent(UserFavoriteJobsActivity.this, ChatActivity.class);
